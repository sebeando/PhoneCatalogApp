...
class ArticlesInfo2 extends Component{
                    ...
                    return(
                        <article className="article-item" id="article-template">
                            ...
                            <div className="cont">
                                ...
                                <h3>
                                    New design<br></br>
                                    6.1 and 5.4-inch sizes<br></br>
                                    5G support<br></br>
                                    OLED displays with Ceramic Shield<br></br>
                                    Dual-lens camera<br></br>
                                    A14 chip<br></br>
                                </h3>
                                <button>
